...
namespace MvvmCrossScaffold001.Core.ViewModels.Monkey
{
    public class MonkeysViewModel : MvxViewModel
    {
        public MvxObservableCollection<MonkeyModel> Monkeys { get; set; } = new MvxObservableCollection<MonkeyModel>();
