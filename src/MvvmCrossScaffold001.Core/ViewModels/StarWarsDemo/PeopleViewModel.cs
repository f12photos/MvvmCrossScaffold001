...
namespace MvvmCrossScaffold001.Core.ViewModels.StarWarsDemo
{
    public class PeopleViewModel : BaseViewModel
    {
        private readonly IStarWarsPeopleService _peopleService;
        private readonly IMvxNavigationService _navigationService;

        private string _nextPage;

        public PeopleViewModel(
            IStarWarsPeopleService peopleService,
            IMvxNavigationService navigationService)
        {
            _peopleService = peopleService;
            _navigationService = navigationService;

            People = new MvxObservableCollection<StarWarsPerson>();

            PersonSelectedCommand = new MvxAsyncCommand<StarWarsPerson>(PersonSelected);
        ...
        private MvxObservableCollection<StarWarsPerson> _people;
        public MvxObservableCollection<StarWarsPerson> People
        {
            get
            {
                return _people;
        ...
        // MVVM Commands
        public IMvxCommand<StarWarsPerson> PersonSelectedCommand { get; private set; }
