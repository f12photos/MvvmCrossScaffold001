...
namespace MvvmCrossScaffold001.iOS.Sources
{
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    public class ArtistTableViewSource : MvxSimpleTableViewSource
    {
        public ICommand FetchCommand { get; set; }

        public ArtistTableViewSource(UITableView tableView) : base(tableView, typeof(ArtistTableViewCell))
        {
